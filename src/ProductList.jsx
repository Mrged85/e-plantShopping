...
function ProductList() {
    ...
    const totalItems = useSelector(selectTotalItems); // Seletor para total de itens
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <p>Total items: {totalItems}</p> {/* Exibe o total de itens no carrinho */}
                    </div>
                </div>
            </div>
